...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App.BeaconServiceConnection, App", BeaconServiceConnection.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BeaconServiceConnection.class)
			mono.android.TypeManager.Activate ("App.BeaconServiceConnection, App", "", this, new java.lang.Object[] {  });
	}
